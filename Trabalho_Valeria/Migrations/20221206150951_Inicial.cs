        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProdutoTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalItensProduto = table.Column<int>(type: "int", nullable: false),
                    ProdutoEnviado = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProdutoEntregueEm = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VendaDetalheId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VendaId = table.Column<int>(type: "int", nullable: false),
                    ProdutoId = table.Column<int>(type: "int", nullable: false),
                    Quantidade = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendasDetalhe", x => x.VendaDetalheId);
                    table.ForeignKey(
                        name: "FK_VendasDetalhe_Produtos_ProdutoId",
                        column: x => x.ProdutoId,
                        principalTable: "Produtos",
                        principalColumn: "ProdutoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VendasDetalhe_Vendas_VendaId",
                        column: x => x.VendaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendasDetalhe_ProdutoId",
                table: "VendasDetalhe",
                column: "ProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_VendasDetalhe_VendaId",
                table: "VendasDetalhe",
                column: "VendaId");
        }
